...
- Added new rule SimpleAsyncComplementaryHelpers that recommends adding Async-based wrapper to Task-based async functions, and viceversa #841 #843 [@webwarrior-ws]
...
- Added new rule DisallowShadowing #112 #676 (opt-in, disabled by default) [@webwarrior-ws] [@knocte]
