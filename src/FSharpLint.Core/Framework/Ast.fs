...
module Ast =
    ...
    [<TailCall>]
    let rec private removeAutoGeneratedMatchesFromLambda = function
    ...
    let private (|IsCurriedLambda|_|) = function
    ...
    [<TailCall>]
    let rec private getLambdaParametersAndExpression parameters = function
